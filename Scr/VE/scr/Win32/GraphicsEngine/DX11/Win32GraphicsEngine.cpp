...
{
	D3D11VertexShader* vs = this->m_system->createVertexShader(L"Scr\\VE\\inc\\Win32\\GraphicsEngine\\Shaders\\VertexShader.hlsl");
	this->m_system->m_deviceContext->setVertexShader(vs);
	D3D11PixelShader* ps = this->m_system->createPixelShader(L"Scr\\VE\\inc\\Win32\\GraphicsEngine\\Shaders\\PixelShader.hlsl");
